                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                ...
                                <p>EWS 163, Rakkar Colony, UNA, Himachal Pradesh, INDIA</p>
                            </div>
                        </div>
                        <div class="address">
                            <div class="address__icon">
                            ...
                            <div class="address__details">
                                <h2 class="ct__title">openning hour of store</h2>
                                <p>9:00AM-10:00PM </p>
                            </div>
                        </div>
    ...
    <script>
        ...
        function init() {
            ...
            var mapOptions = {
                ...
                center: new google.maps.LatLng(31.4607, 76.3015), // Rakkar Colony
